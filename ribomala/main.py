...
""",
    ...
    index_parser.add_argument(
        "-f", "--fasta", type=Path, required=True, help="Path to transcriptome FASTA file"
    )
    ...
    qc_parser.add_argument(
        "-i", "--input", type=Path, required=True, help="Input directory containing BAM files"
    )
    ...
    analysis_parser.add_argument(
        "-c", "--txcsv", type=Path, required=True, help="Path to transcriptome CSV file generated by QC module"
    )
    ...
    analysis_parser.add_argument(
        "-o", "--output", type=Path, required=True, help="Output directory for analysis files"
    )
